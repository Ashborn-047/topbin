...
│
├── data/
│   ├── SOURCES.md                     # Data sources and licensing registry
│   ├── competitions/
...
│   └── team.schema.json
│
├── scripts/                           # Validation & Ingestion Tools
│   ├── validate.js                    # Schema validation (AJV compilation)
│   ├── validate-refs.js               # Referential integrity checker
│   ├── ingest-worldcups.js            # World Cup data ingestion
│   ├── ingest-clubs.js                # Pilot club ingestion script
│   ├── ingestion-log.json             # Ingestion run history registry
│   └── lib/
│       └── llm-extract.js             # NVIDIA NIM API fallback wrapper
│
